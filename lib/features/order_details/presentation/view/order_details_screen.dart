...
import 'package:tracking_app/features/order_details/presentation/widgets/addressSection.dart';
import 'package:tracking_app/features/order_details/presentation/widgets/product_item.dart';
import 'package:tracking_app/generated/locale_keys.g.dart';
import 'package:url_launcher/url_launcher.dart';

class DetailsScreen extends StatefulWidget {
  const DetailsScreen({super.key, this.order});
...
class _DetailsScreenState extends State<DetailsScreen> {
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        OrderProgressIndicator(key: ValueKey(currentStatus),
                        ...
                        AddressSection(
                          ...
                          onTap: () => openWhatsApp(phoneNumber: widget.order?.store?.phoneNumber ?? ''),
                        ),
                        ...
                        const SizedBox(height: 16),
                        Text(
                          LocaleKeys.OrderDetails_orderdetails.tr(),
                            style: AppTheme.lightTheme.textTheme.titleMedium
                        ),
                        const SizedBox(height: 8),
                        ...List.generate(
                            widget.order?.orderItems?.length ?? 0, (index) {
  ...
  Widget _buildStatusCard(OrderDetailsModel order, ) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('${LocaleKeys.OrderDetails_Status.tr()} : ${order.state}',
                style: AppTheme.lightTheme.textTheme.titleSmall
            ...
            const SizedBox(height: 6),
            Text(formattedTime,style: AppTheme.lightTheme.textTheme.bodySmall
